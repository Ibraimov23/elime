...
using ElimeProject.Repository.Childs;
...
namespace ElimeProject
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
           ...
           .UseSqlServer(Configuration.GetConnectionString("ElimeDbContext")));
            ...
            services.AddTransient<INumTableRepository, NumTableRepository>();
